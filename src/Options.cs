...
namespace CustomStomachStorage
{
	public class Options : OptionInterface
	{
		...
		private void InitializeSwallowType(string typeName, bool defaultValue = false)
		{
			...
			//SwallowTypes[typeName] = config.Bind<bool>($"{typeName}_Swallow_conf_{Plugin.MOD_name}", defaultValue);
			GrabTypes[typeName] = config.Bind<bool>($"{typeName}_Grab_conf_{Plugin.MOD_name}", defaultValue);
